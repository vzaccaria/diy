...
.build/10-make.js: src/backends/make.ls
	lsc -b -p -c src/backends/make.ls > .build/10-make.js

.build/11-xcode-make.js: src/backends/xcode-make.ls
	lsc -b -p -c src/backends/xcode-make.ls > .build/11-xcode-make.js

.build/12-file.js: src/file.ls
	lsc -b -p -c src/file.ls > .build/12-file.js

.build/13-index.js: src/index.ls
	lsc -b -p -c src/index.ls > .build/13-index.js

.build/14-livereload.js: src/packs/livereload.ls
	lsc -b -p -c src/packs/livereload.ls > .build/14-livereload.js

.build/15-serve.js: src/packs/serve.ls
	lsc -b -p -c src/packs/serve.ls > .build/15-serve.js

.build/16-web.js: src/packs/web.ls
	lsc -b -p -c src/packs/web.ls > .build/16-web.js

.build/17-tree.js: src/tree.ls
	lsc -b -p -c src/tree.ls > .build/17-tree.js
...
lib/backends/make.js: .build/10-make.js
	@mkdir -p ./lib//backends
	cp .build/10-make.js $@

lib/backends/xcode-make.js: .build/11-xcode-make.js
	@mkdir -p ./lib//backends
	cp .build/11-xcode-make.js $@

lib/file.js: .build/12-file.js
	@mkdir -p ./lib/
	cp .build/12-file.js $@

lib/index.js: .build/13-index.js
	@mkdir -p ./lib/
	cp .build/13-index.js $@

lib/packs/livereload.js: .build/14-livereload.js
	@mkdir -p ./lib//packs
	cp .build/14-livereload.js $@

lib/packs/serve.js: .build/15-serve.js
	@mkdir -p ./lib//packs
	cp .build/15-serve.js $@

lib/packs/web.js: .build/16-web.js
	@mkdir -p ./lib//packs
	cp .build/16-web.js $@

lib/tree.js: .build/17-tree.js
	@mkdir -p ./lib/
	cp .build/17-tree.js $@

.PHONY : build
build: lib/backends/xcode-make/entry.js lib/backends/xcode-make/parseWithData.js lib/backends/xcode-make/readTemplate.js lib/backends/xcode-make/writeProject.js lib/suites/make4web.js lib/suites/xcode4web.js lib/test/test0.js lib/test/test1.js lib/test/test2.js lib/test/test3.js lib/backends/make.js lib/backends/xcode-make.js lib/file.js lib/index.js lib/packs/livereload.js lib/packs/serve.js lib/packs/web.js lib/tree.js
...
.PHONY : clean-24
clean-24: 
	rm -rf .build/0-entry.js .build/1-parseWithData.js .build/2-readTemplate.js .build/3-writeProject.js .build/4-make4web.js .build/5-xcode4web.js .build/6-test0.js .build/7-test1.js .build/8-test2.js .build/9-test3.js .build/10-make.js .build/11-xcode-make.js .build/12-file.js .build/13-index.js .build/14-livereload.js .build/15-serve.js .build/16-web.js .build/17-tree.js lib/backends/xcode-make/entry.js lib/backends/xcode-make/parseWithData.js lib/backends/xcode-make/readTemplate.js lib/backends/xcode-make/writeProject.js lib/suites/make4web.js lib/suites/xcode4web.js lib/test/test0.js lib/test/test1.js lib/test/test2.js lib/test/test3.js lib/backends/make.js lib/backends/xcode-make.js lib/file.js lib/index.js lib/packs/livereload.js lib/packs/serve.js lib/packs/web.js lib/tree.js
